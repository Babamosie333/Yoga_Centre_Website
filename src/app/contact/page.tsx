    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#4A4A4A] font-serif">
      ...
      <header className="pt-32 pb-16 px-8 text-center bg-white">
        ...
        <p className="text-lg text-[#6B705C] max-w-2xl mx-auto font-sans">
          Ready to align your spine and your spirit? Contact us to schedule your chiropractic adjustment or yoga session.
        </p>
      </header>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-sans font-bold text-sm uppercase tracking-widest mb-1">Our Centre</h3>
                    <a 
                    ...
                    >
                      RK Chiro Yoga Centre (Google Maps)
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="mailto:contact@rkchiroyoga.com" 
                      className="text-[#6B705C] hover:text-[#2D3E33] transition-colors"
                    >
                      contact@rkchiroyoga.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6B705C]">+1 (555) 000-0000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-sans font-bold text-sm uppercase tracking-widest mb-1">Operating Hours</h3>
                    <p className="text-[#6B705C]">Mon - Sun: 6:00 AM - 9:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 bg-[#2D3E33] rounded-2xl text-[#FDFBF7]">
              ...
              <p className="text-[#A5A58D] mb-6 font-sans text-sm">
                Click below to send a quick email regarding chiropractic consultations or yoga classes.
              </p>
              <a 
                href="mailto:contact@rkchiroyoga.com?subject=Inquiry for RK Chiro Yoga Centre" 
          ...
          <div className="bg-white p-10 rounded-2xl shadow-sm border border-[#E8E1D5]">
            ...
            <form className="space-y-6 font-sans" onSubmit={(e) => {
              ...
              window.location.href = `mailto:contact@rkchiroyoga.com?subject=Message from ${name}&body=${message}`;
            }}>
              <div className="space-y-2">
                <label className="text-xs uppercase tracking-widest font-bold text-[#6B705C]">Full Name</label>
                <input 
                  name="name"
                  type="text" 
                  required
